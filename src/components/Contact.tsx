              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  >
                    ...
                    >
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.966-.273-.099-.472-.148-.67.149-.199.297-.767.966-.94 1.164-.173.199-.347.223-.644.074-.297-.149-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.447-.52.149-.174.198-.298.298-.497.099-.198.05-.372-.025-.521-.074-.148-.669-1.611-.916-2.207-.242-.579-.487-.501-.669-.51-.173-.007-.372-.009-.571-.009s-.52.074-.792.372c-.272.298-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.1 3.204 5.077 4.487.709.306 1.262.489 1.693.626.712.227 1.36.195 1.872.118.571-.085 1.758-.718 2.006-1.412.248-.694.248-1.29.173-1.412-.074-.124-.272-.198-.57-.347zM12.004 2C6.477 2 2 6.477 2 12.004c0 2.119.556 3.95 1.523 5.59L2 22l4.516-1.486a9.948 9.948 0 005.488 1.57h.004c5.523 0 10-4.477 10-10.004C22.004 6.477 17.527 2 12.004 2z" />
                      </svg>
                    </a>
                  </a>
                  <a
